...
function LevelMaker.generate(width, height)
    ...
    for x = 1, width do
        ...
        -- donot create chasms (empty columns) for last two columns -- for flag
        if math.random(7) == 1 and x < (width - 2) then
            ...
            -- donot create pillar for last two columns -- space for flag
                ...
                table.insert(objects,
                    ...
                    GameObject {
                        ...
                        onCollide = function(player, obj)
                            -- if player has key, remove the lock block
