...
function TakeTurnState:attack(attacker, defender, attackerSprite, defenderSprite, attackerkBar, defenderBar, onEnd)
    ...
    Timer.after(0.5, function()
        ...
        :finish(function()
            ...
            Timer.every(0.1, function()
                defenderSprite.opacity = defenderSprite.opacity == 64/255 and 255/255 or 64/255
            end)
            :limit(6)
            :finish(function()
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        local beforeHP, afterHP = 0, 0
                        local beforeAttack, afterAttack = 0, 0
                        local beforeDefense, afterDefense = 0, 0
                        local beforeSpeed, afterSpeed = 0, 0

                        local HPIncrease, attackIncrease, 
                        defenseIncrease, speedIncrease = 0, 0, 0, 0
                        ...
                        beforeHP = self.playerPokemon.HP
                        beforeAttack = self.playerPokemon.attack
                        beforeDefense = self.playerPokemon.defense
                        beforeSpeed = self.playerPokemon.speed

                        HPIncrease, attackIncrease, defenseIncrease, speedIncrease = self.playerPokemon:levelUp()

                        afterHP  = self.playerPokemon.HP
                        afterAttack = self.playerPokemon.attack
                        afterDefense = self.playerPokemon.defense
                        afterSpeed = self.playerPokemon.speed
                        ...
                        -- push a level up menu onto the stack along with before, after, increase in stats
